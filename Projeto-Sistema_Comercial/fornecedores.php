    ...
    <body>
            ...
            <div class="container text-center col-md-8 col-sm-8 col-xs-12">
                    ...
                    <div class="text-center">
                        <p>
                        <a href="create-fornecedor.php" class="btn btn-success">Adicionar</a>
                     </p>
                     </div>    
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            foreach($pdo->query($sql)as $row)
                            {
                                ...
                                echo '<td width=250>';
                                echo '<a class="btn btn-primary" href="read-fornecedor.php?id='.$row['id'].'">Info</a>';
                                echo ' ';
                                echo '<a class="btn btn-warning" href="update_fornecedor.php?id='.$row['id'].'">Atualizar</a>';
                                echo ' ';
                                echo '<a class="btn btn-danger" href="delete-fornecedor.php?id='.$row['id'].'">Excluir</a>';
                                echo '</td>';
                                echo '</tr>';
                            }
                            Banco::desconectar();
