        ...
        <div class="container text-center">
            <div class="container col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                <div class="text-center">
                    <h3 class="well">Excluir Fornecedor</h3>
                </div>
                <form class="form-horizontal" action="delete-fornecedor.php" method="post">
                    <input type="hidden" name="id" value="<?php echo $id;?>" />
                    <div class="alert bg-warning"> Deseja excluir este fornecedor?</div>
                    <div class="form actions">
                        <button type="submit" class="btn btn-info">Sim</button>
                        <a href="fornecedores.php" type="btn" class="btn btn-default">Não</a>
                    </div>
                </form>
            </div>
        </div>
